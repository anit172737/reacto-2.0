...
const NextJsTable = () => {
  ...
  const { nextQtnList, openForm, openDeleteForm, selected, total } =
    useSelector((state) => state.nextMaster);
  ...
  const handleDelete = (payload) => {
    dispatch(deleteNextQtn(payload));
  ...
  useEffect(() => {
    window.top.document.title = "nextjs";
    const payload = {
      search: search,
      pageSize,
      pageNumber: currentPage,
